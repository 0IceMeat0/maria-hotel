...
const Header = () => {
  ...
  return(
    <div className={styles.block}>
     ...
     <a className={styles.link} href="#places" >Номера</a>
     <a className={styles.link} href="#bany" >Баня</a>
     <a className={styles.link} href="#places" >Территория</a>
     <a className={styles.link} href="#ysloviya" >Условия размещения</a>
     <a className={styles.link} href="#contacts" >Адрес и контакты</a>
      </div>
