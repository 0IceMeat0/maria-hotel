            ...
            <div className={styles.container}>
                ...
                <div className={styles.companyInfo}>
                    ...
                    <p className={styles.description}>
                        Арендуйте уютный дом на озере Банное в Башкирии!
                        <br />
                        🌲🏡 Идеально подходит для семейного отпуска и отдыха со
                        своей второй половинкой. Наш коттедж расположен рядом с
                        горнолыжным центром “Банное”, что делает его отличным
                        вариантом для зимнего и летнего отдыха.
                    </p>
                    <p className={styles.description}>
